...
#date1='Vip-R2023.07.01'
sed -i 's/$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)/$(shell TZ=UTC-8 date +%Y%m%d -d +12hour)-Ipv4-VIP-/g' include/image.mk
if [ "$VER2" = "5.4" ]; then
