...
#date1='Ipv6-Super-R2023.05.01'
#sed -i 's/$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)/20230501-Ipv6-Super-5.15-/g' include/image.mk
if [ "$VER2" = "5.4" ]; then
