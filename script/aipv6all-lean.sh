...
# date1='Ipv6-Plus-Vip-R2023.09.01'
# sed -i 's/$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)/20230901-Ipv6-Plus-VIP-6.1-/g' include/image.mk
if [ "$VER2" = "5.4" ]; then
