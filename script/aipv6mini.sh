...
date1='Ipv6-Mini-Vip-R2022.12.01'
sed -i 's/$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)/20221201-Ipv6-Mini-VIP-5.15-/g' include/image.mk
if [ "$VER2" = "5.4" ]; then
