...
#date1='Ipv6-Mini-Vip-R2023.07.01'
#sed -i 's/$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)/20230701-Ipv6-Mini-VIP-6.1-/g' include/image.mk
if [ "$VER2" = "5.4" ]; then
