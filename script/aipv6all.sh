...
svn export https://github.com/loso3000/mypk/trunk/up/luci-theme-catq package/cfeeds/packages/luci-theme-kucat
sed -i 's/qcatku/kucat/g' ./package/lean/luci-app-kucat
sed -i 's/qcatku/kucat/g' package/cfeeds/packages/luci-theme-kucat
