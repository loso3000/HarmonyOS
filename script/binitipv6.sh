...
rm -rf ./cfeeds/packages/admin/netdata
svn export https://github.com/sirpdboy/sirpdboy-package/trunk/luci-app-netdata ./cfeeds/luci/applications/luci-app-netdata
svn export https://github.com/loso3000/mypk/trunk/up/netdata ./cfeeds/packages/admin/netdata
ln -sf ../../../cfeeds/luci/applications/luci-app-netdata ./package/feeds/luci/luci-app-netdata
rm -rf ./fceeds/luci/applications/luci-app-netdata/root/etc/uci-defaults/
...
#date1='Ipv6-Plus-R2023.06.01'
#sed -i 's/$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)/20230601-Ipv6-Plus-6.1-/g' include/image.mk
if [ "$VER2" = "5.4" ]; then
