...
date1='Ipv6-Plus-S20220626'
sed -i 's/$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)/20220626-Ipv6-Plus-5.15-/g' include/image.mk
if [ "$VER2" = "5.4" ]; then
