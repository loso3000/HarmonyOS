...
date1='Ipv6-Plus-VIP'`TZ=UTC-8 date +%Y.%m.%d -d +"12"hour`
...
#sed -i 's/$(VERSION_DIST_SANITIZED)-$(IMG_PREFIX_VERNUM)$(IMG_PREFIX_VERCODE)$(IMG_PREFIX_EXTRA)/20220415-Ipv6-Plus-VIP-5.19-/g' include/image.mk
