...
svn export https://github.com/loso3000/mypk/trunk/up/luci-app-catplus ./package/lean/luci-app-advancedplus
...
svn export https://github.com/loso3000/mypk/trunk/up/luci-theme-kcat ./package/lean/luci-theme-kucat
